...
describe('Network Blockchain Bitcoin', function() {
  ...
  it('query addresses', function (done) {
    blockchainInfo.queryAddress(['1AjAF7bZvimjdTuPnWLNN3F4WCbzLbuyG7', '1j1UHnGwDdJhNf2h3mcFmzGDe2DzoEMuc'], function(error, response) {
      try {
